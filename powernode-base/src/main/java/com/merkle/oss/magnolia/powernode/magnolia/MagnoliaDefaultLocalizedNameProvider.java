...
public class MagnoliaDefaultLocalizedNameProvider implements LocalizedNameProvider {
	private final I18nContentSupport i18nContentSupport;

	@Inject
	public MagnoliaDefaultLocalizedNameProvider(final I18nContentSupport i18nContentSupport) {
